					...
					<div v-if="Math.abs(index-idx)<=1" class="video-box">
						<block v-if="item.src">
							...
							<cover-view class="cover-view-right">
								...
								<cover-image :src="item.check?'../../static/image/fabu.png':'../../static/image/fabu.png'" class="img" @click.stop="tapLove"></cover-image>
								...
								<cover-image src="../../static/image/fabu.png" class="img" @click.stop="tapMsg(item)"></cover-image>
								...
								<cover-image src="../../static/image/fabu.png" class="img" @click.stop="tapShare"></cover-image>
						...
						<image src="../../static/image/fabu.png" :style="{ height: height }" v-else  class="video-box"></image>
					</div>
...
<script>
	import chunleiVideo from '../chunlei-video/chunlei-video'
    export default { 
		components:{
			chunleiVideo
		},
        data() {
            return {
				...
				videoList:[
					{src:"https://videocdn.jellow.site/lr2GzKAHbbLQYz1aL4s3Vex60zmM.mp4?sign=be7a7311c6dc2000837ce58a0d619e50&t=5f96beba",
						content:1234567,
						flag:true,
						check:false,
						like:'7w',
						...
						avater:'../../static/image/fabu.png',
						initialTime:30,
						duration:"https://videocdn.jellow.site/lr2GzKAHbbLQYz1aL4s3Vex60zmM.mp4?sign=be7a7311c6dc2000837ce58a0d619e50&t=5f96beba",
					}
				],
				height:'667px',
				index:0,
