...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _indexHeader = _interopRequireDefault(__webpack_require__(/*! ./index-header.vue */ 18));\nvar _functionbox = _interopRequireDefault(__webpack_require__(/*! ./functionbox.vue */ 24));\nvar _synopsis = _interopRequireDefault(__webpack_require__(/*! ./synopsis.vue */ 48));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar videoJson = __webpack_require__(/*! ./mock-video.js */ 55);__f__(\"log\", videoJson, \" at components/Home/swiper-vertical.nvue:31\");var timer = null;var _default = { components: { 'index-header': _indexHeader.default, functionbox: _functionbox.default, synopsis: _synopsis.default }, data: function data() {return { videoIndex: 0, vlist: videoJson, isPlay: false, //当前视频是否播放中\n      clickNum: 0, screenHeight: 0, screenWidth: 0 //记录点击次数\n    };}, onLoad: function onLoad() {}, mounted: function mounted() {this.init();var height = 0;var width = 0;\n    uni.getSystemInfo({\n      success: function success(res) {\n        height = res.screenHeight - 50 + 'px';\n        width = res.screenWidth + 'px';\n      } });\n\n    this.screenHeight = height;\n    this.screenWidth = width;\n  },\n  methods: {\n    init: function init() {var _this = this;\n      setTimeout(function () {\n        _this.play(_this.videoIndex);\n      }, 200);\n    },\n    handleSlider: function handleSlider(e) {\n      // 滑动切换\n      var curIndex = e.detail.current;\n      this.play(e);\n      if (curIndex === this.videoIndex + 1) {\n        __f__(\"log\", '向上滑动', \" at components/Home/swiper-vertical.nvue:77\");\n        this.$refs.players[this.videoIndex + 1].play(); // 下一个开始播放并且从头开始播放\n        this.$refs.players[this.videoIndex].pause(); // 当前视频暂停播放\n      } else if (curIndex === this.videoIndex - 1) {\n        __f__(\"log\", '向下滑动', \" at components/Home/swiper-vertical.nvue:81\");\n        this.$refs.players[this.videoIndex - 1].play(); // 上一个开始播放并且从头开始播放\n        this.$refs.players[this.videoIndex].pause(); // 当前视频暂停播放\n      }\n      this.videoIndex = curIndex;\n    },\n    play: function play(index) {\n      // 播放\n      this.$refs.players[this.videoIndex].play();\n      this.isPlay = true;\n    },\n    // 暂停\n    pause: function pause(index) {\n      this.$refs.players[this.videoIndex].pause();\n      this.isPlay = false;\n    },\n    // 点击视频事件\n    handleClicked: function handleClicked(index) {var _this2 = this;\n      if (timer) {\n        clearTimeout(timer);\n      }\n      this.clickNum++;\n      timer = setTimeout(function () {\n        if (_this2.clickNum >= 2) {\n          __f__(\"log\", '双击视频', \" at components/Home/swiper-vertical.nvue:105\");\n        } else {\n          __f__(\"log\", '单击视频', \" at components/Home/swiper-vertical.nvue:107\");\n          if (_this2.isPlay) {\n            _this2.pause(index);\n          } else {\n            _this2.play(index);\n          }\n        }\n        _this2.clickNum = 0;\n      }, 300);\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 12)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///17\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      show: 0 };\n\n  },\n  methods: {\n    changexihuan: function changexihuan() {\n      if (this.show === 0) {\n        this.show = 1;\n      } else {\n        this.show = 0;\n      }\n    },\n    getpinlun: function getpinlun() {\n      this.$refs.popup.open();\n    },\n    goshare: function goshare() {\n      this.$refs.popup2.open();\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///45\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {};\n\n\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///52\n");
